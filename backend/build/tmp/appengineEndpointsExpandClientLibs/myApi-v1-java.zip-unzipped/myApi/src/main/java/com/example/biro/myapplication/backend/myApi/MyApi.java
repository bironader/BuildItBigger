 ...
 * on 2017-08-06 at 14:45:33 UTC 
 * Modify at your own risk.
 */

package com.example.biro.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "pullJokes".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link PullJokes#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public PullJokes pullJokes() throws java.io.IOException {
    PullJokes result = new PullJokes();
    initialize(result);
    return result;
  }

  public class PullJokes extends MyApiRequest<com.example.biro.myapplication.backend.myApi.model.Jokes> {

    private static final String REST_PATH = "pullJokes";

    /**
     * Create a request for the method "pullJokes".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link PullJokes#execute()} method to invoke the remote operation. <p>
     * {@link
     * PullJokes#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected PullJokes() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.biro.myapplication.backend.myApi.model.Jokes.class);
    }
    ...
    @Override
    public PullJokes setAlt(java.lang.String alt) {
      return (PullJokes) super.setAlt(alt);
    }

    @Override
    public PullJokes setFields(java.lang.String fields) {
      return (PullJokes) super.setFields(fields);
    }

    @Override
    public PullJokes setKey(java.lang.String key) {
      return (PullJokes) super.setKey(key);
    }

    @Override
    public PullJokes setOauthToken(java.lang.String oauthToken) {
      return (PullJokes) super.setOauthToken(oauthToken);
    }

    @Override
    public PullJokes setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (PullJokes) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public PullJokes setQuotaUser(java.lang.String quotaUser) {
      return (PullJokes) super.setQuotaUser(quotaUser);
    }

    @Override
    public PullJokes setUserIp(java.lang.String userIp) {
      return (PullJokes) super.setUserIp(userIp);
    }

    @Override
    public PullJokes set(String parameterName, Object value) {
      return (PullJokes) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.biro.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.biro.myapplication.backend.myApi.model.MyBean.class);
